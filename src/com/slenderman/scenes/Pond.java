...
public class Pond {
    ...
    public void inFrontOfPond() {
        ...
        System.out.println("It is filled with fog and you can vary see what's on the other side of the pond");
    ...
    public void inFrontOfPondChoice(){
        ...
        if (choice.equals("0")){
            ...
            System.out.println("Also, you see ripples and heard something moving on the surface of the pond");
    ...
    private void inFrontOfPondChoice_UseItems(){
        ...
        System.out.println("Would you like to list up what you have?"+
                "\n- Type \"Y\" : Yes" +
                "\n- Type \"N\" : No");
            ...
            if ((localItems.contains("FOG_GLASSES"))||(localItems.contains("RING_BOX_KEY"))|| true /* or boat*/) {
                ...
                do {
                    ...
                    if ((choice.equals("K")) && localItems.contains("RING_BOX_KEY")) {
                        System.out.println("You chose the key, but you are not sure how you use it");
                        ...
                        choice = playerChoice().toUpperCase();
                        if (choice.equals("0")) {
                            System.out.println("You do not see anything special about the glasses. You see stars in the sky");
                        } else if (choice.equals("1")) {
                            System.out.println("You do not see anything special about the glasses. You see rocks on the ground");
                        } else if (choice.equals("2")) {
                            System.out.println("You slowly put the glasses on and looked straight.");
                            System.out.println("Before putting them on, you could not see anything on the pond because of the fog");
                            System.out.println("However, now you can clearly see though the fog. ");
                        ...
                        if (choice.equals("Y")) {
                            if (!wearingFogGlasses) {
                                ...
                                System.out.println("You decided to visit a small island in the middle of the pond");
                                inFontOfIsland();
                                break;
                            }
                        }
        ...
        if (choice.equals("L")){
            ...
            if (choice.equals("Y")){
                if (countCheckBackPack == 0) {
                    ...
                    if (!localItems.contains("FOG_GLASSES")){
                        System.out.println("You shook the backpack. You heard something inside moved");
                        ...
                        if (choice.equals("0")){
                            ...
                            System.out.println("You decide to keep it");
                            localItems.add("FOG_GLASSES");
                            System.out.println("You just added the glasses in your collection");
                        }
                        else{
    ...
    private void inFrontOfPondChoice_WalkAround_Right(){
        ...
        String choice = playerChoice().toUpperCase();
        if (choice.equals("0")){
            System.out.println("You see so many stars. But the darkness is filled with where you are");
            System.out.println("It is as if you were at the button of a deep cave and you see sunshine, " +
                    "but it is so far away that you cannot reach. Even you shout, nobody at the entrance would " +
                    "realize somebody is seeking for a help from the button of the cave");
            inFrontOfPondChoice_WalkAround_Right();
        }
        else{
            if (!localItems.contains("RING_BOX_KEY")){
                ...
                if (choice.equals("Y")) {
                    ...
                    choice = playerChoice().toUpperCase();
                    if(choice.equals("Y")) {
                        System.out.println("You now added a key to your collection");
                ...
                System.out.println("\n\"Island..... Tree.... Fog...\"");
                System.out.println("\nAs soon as you read it, it bursted into a flame.");
    ...
    private void inFontOfIsland() {
        System.out.println("\nYou rowed the boat for a while. Thanks to the special glasses, " +
                ...
                "you cannot see even your feet");
        System.out.println("You came to the island");
    ...
    private void onIsland(){
        ...
        if (choice.equals(0)){
            ...
            System.out.println("It must have built for a long time ago. Creepers grow along the cross");
            crossVisited = true;
            onIsland();
        }
        else{
            if (!crossVisited) {
                System.out.println("You walked around the tree. You do not find any clues about where you should go or what you should do");
                onIsland();
            }
            else{
                onIsland_lookUpDown();
    ...
    private void onIsland_lookUpDown(){
        ...
        if (choice.equals("0")){
            if (!islandTreeLookDown) {
                ...
                System.out.println("Looks like they are moving down slowly and silently toward you.");
            ...
            if (!isFogClear) {
                ...
                System.out.println("You remember you found a key in a ring box. You took it out and insert the key and rotate.");
                System.out.println("Suddenly, the dense fog filled on the pond started clearing out.");
