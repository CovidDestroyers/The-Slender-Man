...
//      System.out.println(
//          ANSI_WHITE
//              + "You are walking towards the house, "
//              + "when your flashlight begins to flicker.\n");
  ...
  public void houseInView() throws InterruptedException {
    try {
      ...
      Thread.sleep(1000);
//      System.out.println(textPainter(bundle.getString("houseInView_1")));
//      System.out.println(
//          ANSI_GREEN
      System.out.println(
              "\n"
      ...
      //System.out.println("It gives easily as you tumble into the now " + "dark house.\n");
    } catch (InterruptedException e) {
      System.out.println("Awe you broke it :(");
      e.printStackTrace();
    }
...
//              + "bookshelf near the window to your left.\n");
      Thread.sleep(1000);
//      System.out.println(textPainter(bundle.getString("inHouse_2")));
      System.out.println(
...
//      System.out.println(
//          "There is a small kitchen, a small " + "dining table, and one chair to your right.\n");
      Thread.sleep(1000);
...
//      System.out.println(
//          ANSI_BLUE
//              + "You have opened the lockbox! You are "
//              + "awarded a lighter.\nMay it light your path in times"
//              + " of darkness.\n");
    }
    else {
      displayStories("unlockLockBox_needKey");
      //System.out.println(ANSI_RED + "You need a key to open this box you half" + " wit!");
    }
  }
